...
public final class JSONStream {
    ...
    /**
     * Recursively dig into {@link org.codehaus.jettison.json.JSONObject} structure
     *
     * @param path          current path
     * @param jsonObject    source
     * @return
    ...
    /**
     * Recursively dig into {@link org.codehaus.jettison.json.JSONArray} structure
     *
     * @param path          current path
     * @param jsonArray     source
     * @return
    ...
    /**
     * Stream direct children of {@link org.codehaus.jettison.json.JSONObject}
     *
     * @param jsonObject        source
     * @param valueExtractor    extractor
     * @param <V>
    ...
    /**
     * Stream direct children of {@link org.codehaus.jettison.json.JSONArray}
     *
     * @param jsonArray         source
     * @param valueExtractor    extractor
     * @param <V>
    ...
    public static <V> Stream<V> ofAnotherJson(final org.codehaus.jettison.json.JSONArray jsonArray, final BiFunction<org.codehaus.jettison.json.JSONArray, Integer, V> valueExtractor) {
        ...
        int length = Optional.ofNullable(jsonArray)
                .map(org.codehaus.jettison.json.JSONArray::length)
                .orElse(0);
